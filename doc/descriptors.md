# Support for Output Descriptors in Brebcoin Core

Since Brebcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Brebcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Brebcoin Core wallets, a convenience function `combo` is

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " brebcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  brebcoin-tx [options] <hex-tx> [commands]  Update hex-encoded brebcoin transaction\n" +
            "or:     brebcoin-tx [options] -create [commands]   Create hex-encoded brebcoin transaction\n" +
            "\n";

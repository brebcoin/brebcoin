...
#if defined(NDEBUG)
# error "Brebcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Brebcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
...

    {
        ...
        for (CTxMemPool::txiter it : allConflicting)
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BREB additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("brebcoin-scriptch");

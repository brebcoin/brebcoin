...
const char * const BITCOIN_CONF_FILENAME = "brebcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Brebcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Brebcoin";
#else
    // Unix
    return pathRet / ".brebcoin";
#endif
#endif
}

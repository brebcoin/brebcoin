...
"""Verify that starting brebcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start brebcoin with -h for help text")
        ...
        self.log.info("Start brebcoin with -version for version information")
        ...
        self.log.info("Start brebcoind with -fakearg to make sure it does not start")
